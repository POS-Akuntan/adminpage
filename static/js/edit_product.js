...
const fetchProduct = async (productId) => {
    try {
        ...
        console.log("Product Category:", product.category); // Debugging kategori produk

        // Isi data di form
        document.getElementById("name").value = product.name;
        document.getElementById("price").value = product.price;
        document.getElementById("category").value = product.category; // Pastikan elemen ini ada di HTML
...
document.getElementById("edit-product-form").addEventListener("submit", async function (event) {
    ...
    const updatedProduct = {
        ...
        category: document.getElementById("category").value, // ID kategori
